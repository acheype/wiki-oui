...
describe("SuggestionInput", () => {
  ...
  // Leaving the field (real focus, relatedTarget) moved to a browser test —
  // suggestion-input.browser.test.tsx (ADR 0032). jsdom couldn't produce a
  // real blur without a fake Tab target.
