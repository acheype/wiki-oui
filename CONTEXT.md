...
_Avoid_: handler (pour un service) ; réserver un segment d'URL de niveau 1 par service (deux segments réservés en tout, `api` et `installation` — ADR 0028)
