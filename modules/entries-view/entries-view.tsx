...
import {
  ...
  getEntriesViewData,
} from "@/modules/entries-view/actions";
...
import {
  ...
  queryEntries,
  sortEntries,
} from "@/modules/entries-view/rules";
...
const MapEntriesView = dynamic(
  () => import("./views/map-view").then((mod) => mod.MapEntriesView),
  {
    ssr: false,
    loading: () => (
...
export type { EntriesViewProps } from "./views/types";
