...
Trois identifiants suivent le même motif — **dérivé automatiquement, caché par défaut, révélable en un clic pour le personnaliser, figé au premier enregistrement** :
