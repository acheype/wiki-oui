...
import { Menu } from "@/components/wiki/menu";
...
// see lib/mdx-menu.test.tsx for the plumbing that produces it for real.
//
// Kept out of components/wiki/ on purpose: lib/mdx.tsx's registry loader
// treats every .tsx file there as a component to serve, so a test file
// sitting in that folder would itself become an unresolvable tag.
